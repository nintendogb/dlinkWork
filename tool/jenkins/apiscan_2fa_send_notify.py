...
LOG_DIR = '/var/log/jenkins_scan/2fa_apiscan'
RES_LOG = f'{LOG_DIR}/2fa_{args.site}_{args.time}_res.log'
...
SUB = f'Result of [{args.time}] {args.site} 2FA apiscan test'
LOG_LIST = [ f'{LOG_DIR}/2fa_{args.site}_{args.time}_api_response.log' ]
ERROR_STR = get_fail_item()
TOTAL_RES = get_total_res()
SLACK_MSG = f'[{args.time}] {args.site} 2FA apiscan 已結束\n'
MAIL_CONTENT = f'''
{args.site} 2FA apiscan test just start at {args.time} has finished.
